...
WORKING_SEEDS = {
    10: list(range(50)),
    12: [1,2,3,5,6,7,8,14,15,16,23,28,29,30,32,33,34,36,37,39,42,47],
    20: list(range(50)),
    30: [],
    37: [],
    44: [2,3,7,8,9,10,11,12,16,17,18,19,22,23,24,31,32,33,35,39,40,42,44,45,49],
    49: [9,11,14,15,18,19,20,21,23,24,26,28,30,32,34,35,38,39,43,44,45,46,47,49,50],
}
